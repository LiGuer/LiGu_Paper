* 概率论
	...
	* 概率
		...
		* \Theorem{中心极限定律}
			$\lim_{n \to\infty} F_n(x) =\lim_{n \to\infty} \P\{\frac{\sum_{k=1}^n X_k - n \mu}{\sqrt{n} \sigma} ≤ x\}=\int_{-\infty}^x \frac{1}{\sqrt{2 \pi}} e^{-t^2 / 2} \d t=\Phi(x)$
							...
							* 方差 $\. \Sigma$
							\Proof
								...
								$
									...
									&= \sqrt{2 \pi \lambda_k}  \tag{$\Gamma(\frac{1}{2}) = \sqrt{\pi}$}
								$
