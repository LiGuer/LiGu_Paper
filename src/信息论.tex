        ...
        * 平均自信息
            * 离散集合
                ...
                * \def{交叉熵} 若P和Q为定义在同一概率空间的两个概率测度，定义P相对于Q的散度为: $D(\P || \mathbb Q)=\sum_x \P(x) \log \frac{\P(x)} \mathbb Q(x)}$
                ...
                \bf{关系}
                    * $H(Y|X) \le H(Y)$: 信息处理中, 条件越多, 熵越小. (当且仅当$X_i$相互独立, 则等式成立.)
                    * $H(X_1...X_n) \le \sum_{i=0}^n H(X_i)$ (当且仅当$X_i$相互独立, 则等式成立.)
...
* 信源
    ...
    * 信源编码
        ...
        \Property
            ...
            * \bf{无失真信源编码}: 只要信源编码的码率不小于信源的熵就存在无失真信源编码，否则就不存在无失真信源编码，$ R \ge H \quad \Leftrightarrow \quad \exists \text{无失真信源编码}$.
        ...
        * 定长码
            ...
            \Property
                ...
                * 序列长度: $N \ge \frac{\sigma^2} \delta^2 \varepsilon}=(\frac{\eta} 1-\eta})^2 \cdot \frac{\sigma^2} H^2(X) \varepsilon}$
